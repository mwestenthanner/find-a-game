...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    let xboxIcon = ref(false);
    let pcIcon = ref(false);
    let xcloudIcon = ref(false);

    function setTagText() {
      if (props.game.comingSoon == true) {
        showTag.value = true;
        tagText.value = 'Coming soon';
      } 

      else if (props.game.leavingSoon == true) {
        showTag.value = true;
        tagText.value = 'Leaving soon';
      } 
    }
    ...
    function hoverInfo() {
      ...
      if (props.game.comingSoon == true || props.game.leavingSoon == true) {
    ...
    function setIcons() {
      ...
      if (props.game.platform.includes('PC')) {
        pcIcon.value = true;
      }

      if (props.game.platform.includes('Xbox')) {
        xboxIcon.value = true;
      }
